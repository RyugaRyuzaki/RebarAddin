                        ...
                        for (int i = 0; i < foundationPileModel.GroupFoundationModels.Count; i++)
                        {
                            for (int j = 0; j < foundationPileModel.GroupFoundationModels[i].FoundationModels.Count; j++)
                            {
                                ...
                                if (foundationPileModel.GroupFoundationModels[i].FoundationModels[j].IsRepresentative&& foundationPileModel.SettingModel.FoundationDetailViewType!=null)
                                {
                                    ...
                                    foundationPileModel.GroupFoundationModels[i].FoundationModels[j].CreateFoundationSectionHorizontal(document, unit, foundationPileModel.SettingModel, foundationPileModel.GroupFoundationModels[i].Image, foundationPileModel.GroupFoundationModels[i].Type); foundationPileModel.ProgressModel.SetValue(uc, 1);
                                    foundationPileModel.GroupFoundationModels[i].FoundationModels[j].CreateFoundationSectionVertical(document, unit, foundationPileModel.SettingModel, foundationPileModel.GroupFoundationModels[i].Image, foundationPileModel.GroupFoundationModels[i].Type); foundationPileModel.ProgressModel.SetValue(uc, 1);
