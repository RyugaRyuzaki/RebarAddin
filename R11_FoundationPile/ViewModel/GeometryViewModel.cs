    ...
    public class GeometryViewModel : BaseViewModel
    {
        ...
        public GeometryViewModel(Document doc, FoundationPileModel foundationPileModel, UnitProject unitProject)
        {
            ...
            ReverseFoundationCommand = new RelayCommand<FoundationPileWindow>((p) => { return SelectedGroupFoundationModel.IsGenerate && !FoundationPileModel.IsCreateGrounpFoundation&& (SelectedGroupFoundationModel.Image==0|| SelectedGroupFoundationModel.Image==2)&& SelectedFoundationModel!=null; }, (p) =>
            {
                ...
                SelectedFoundationModel.GetBoundingFoundation(SelectedGroupFoundationModel.Image, FoundationPileModel.SettingModel, SelectedGroupFoundationModel.L1, SelectedGroupFoundationModel.L2, SelectedGroupFoundationModel.LayerPileModels);
                SelectedFoundationModel.GetAllPiles(SelectedGroupFoundationModel.Image, FoundationPileModel.SettingModel, SelectedGroupFoundationModel.L1, SelectedGroupFoundationModel.L2, SelectedGroupFoundationModel.LayerPileModels);
                DrawMain(p);
            });
            ...
            ApplyRepresentativeCommand = new RelayCommand<FoundationPileWindow>((p) => { return SelectedGroupFoundationModel.IsGenerate && !IsEnabled && SelectedFoundationModel != null && !SelectedFoundationModel.IsRepresentative; }, (p) =>
             {
