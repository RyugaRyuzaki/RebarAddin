...
namespace R10_WallShear.LanguageModel
{
    public class BarsLanguage : BaseViewModel
    {
        ...
        private string _CornerInformation;
        public string CornerInformation { get { return _CornerInformation; } set { _CornerInformation = value; OnPropertyChanged(); } }
        ...
        private void GetLanguageEN()
        {
            ...
            CornerInformation = "Corner Information";
        }
        private void GetLanguageVN()
        {
            ...
            CornerProperty = "Thông Số Thép Góc";
            CornerInformation = "Thông tin Thép Góc";
        }
    }
}
