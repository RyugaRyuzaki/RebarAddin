...
namespace R10_WallShear.LanguageModel
{
    public class SettingLanguage : BaseViewModel
    {
        ...
        private string _ParameterWalls;
        public string ParameterWalls { get { return _ParameterWalls; } set { _ParameterWalls = value; OnPropertyChanged(); } }
        private string _WallsName;
        public string WallsName { get { return _WallsName; } set { _WallsName = value; OnPropertyChanged(); } }
        ...
        private void GetLanguageEN()
        {
            ...
            ParameterWalls = "Parameter Walls";
            WallsName = "Walls Name";
        ...
        private void GetLanguageVN()
        {
            ...
            ParameterWalls = "Parameter Tường";
            WallsName = "Tên Tường";
