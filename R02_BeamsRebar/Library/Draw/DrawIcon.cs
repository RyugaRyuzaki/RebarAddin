...
namespace R02_BeamsRebar
{
    public class DrawIcon
    {
        ...
        {
            Rectangle r1 = new Rectangle() { Width = 8, Height = 16 };
            r1.Stroke = Brushes.Black;
            r1.StrokeThickness = 0.8;
            Canvas.SetTop(r1,8);
            Canvas.SetLeft(r1, 0);
            Rectangle r2 = new Rectangle() { Width = 8, Height = 16 };
            r2.Stroke = Brushes.Black;
            r2.StrokeThickness = 0.8;
            Canvas.SetTop(r2, 8);
            Canvas.SetLeft(r2, 24);
            Rectangle r3 = new Rectangle() { Width = 16, Height = 8 };
            r3.Fill = Brushes.Red;
            Canvas.SetTop(r3, 12);
            Canvas.SetLeft(r3, 8);
        ...
        public static void DrawAddBar(Canvas canvas,bool top)
        {
            ...
            {
                Line l4 = new Line() { X1 = 0, X2 = 12, Y1 = 20, Y2 = 20 };
                l4.Stroke = Brushes.Red;
                l4.StrokeThickness = 2;
                canvas.Children.Add(l4);
                Line l5 = new Line() { X1 = 20, X2 = 32, Y1 = 20, Y2 = 20 };
                l5.Stroke = Brushes.Red;
                l5.StrokeThickness = 2;
                canvas.Children.Add(l5);
            }
        ...
        public static void DrawSpecialBar(Canvas canvas)
        {
            ...
            Canvas.SetLeft(r1, 0);
            canvas.Children.Add(r1);
            Line l1 = new Line() { X1 = 12, X2 = 12, Y1 = 0, Y2 = 16 };
            l1.Stroke = Brushes.Black;
            l1.StrokeThickness = 1;
            canvas.Children.Add(l1);
            Line l2 = new Line() { X1 = 12, X2 = 20, Y1 = 0, Y2 = 0 };
            l2.Stroke = Brushes.Black;
            l2.StrokeThickness = 1;
            canvas.Children.Add(l2);
            Line l3 = new Line() { X1 = 20, X2 = 20, Y1 = 0, Y2 = 16 };
            l3.Stroke = Brushes.Black;
            l3.StrokeThickness = 1;
            canvas.Children.Add(l3);
            Line l4 = new Line() { X1 = 0, X2 = 6, Y1 = 20, Y2 = 20 };
            l4.Stroke = Brushes.Red;
            l4.StrokeThickness = 2;
            canvas.Children.Add(l4);
            Line l5 = new Line() { X1 = 6, X2 = 12, Y1 = 20, Y2 = 28 };
            l5.Stroke = Brushes.Red;
            l5.StrokeThickness = 2;
            canvas.Children.Add(l5);
            Line l6 = new Line() { X1 = 12, X2 = 20, Y1 = 28, Y2 = 28 };
            l6.Stroke = Brushes.Red;
            l6.StrokeThickness = 2;
            canvas.Children.Add(l6);
            Line l7 = new Line() { X1 = 20, X2 = 26, Y1 = 28, Y2 = 20 };
            l7.Stroke = Brushes.Red;
            l7.StrokeThickness = 2;
            canvas.Children.Add(l7);
            Line l8 = new Line() { X1 = 26, X2 = 32, Y1 = 20, Y2 = 20 };
