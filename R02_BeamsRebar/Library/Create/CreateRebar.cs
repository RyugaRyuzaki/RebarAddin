...
namespace R02_BeamsRebar
{
    public class CreateRebar
    {
        ...
        {
            GetProgressBarRebar(document, p, BeamsModel);
            ...
            CreateDimensionStirrupBar(action, p, BeamsModel, document, unit, dsmax);
        ...
        private static void CreateDimensionStirrupBar(string action, BeamsWindow p, BeamsModel BeamsModel, Document document, UnitProject unit, double dsmax)
        {
        ...
        private static void GetProgressBarRebar(Document document, BeamsWindow p, BeamsModel BeamsModel)
        {
            BeamsModel.Value = 0;
